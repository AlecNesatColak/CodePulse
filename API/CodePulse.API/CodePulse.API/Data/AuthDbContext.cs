    ...
    public class AuthDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            var admin = new IdentityUser()
            {
                ...
                PasswordHash = "AQAAAAIAAYagAAAAEPcn6Sy3DGFL/LlV+jmAFDuJTJBEROKpc4pHesv5nZWkMLNnMqhTBSL92ZlCgbkGLg==",
                SecurityStamp = "fdb370c0-fb15-4df1-9337-0c7769bb0b2a",     // Static
                ConcurrencyStamp = "8a9e4c4f-ec14-4b4a-b7f0-17d5c9e9c938"    // Static
            };
